const northcodersInterests = [{
  ...
  "person": {
    "interests": ["Climbing", "Skating", "4 hour youtube holes about future African engineering projects"],
    "username": "tomosim"
  }
}, {
  "person": {
  ...
  "person": {
    "interests": ["comfort eating", "code", "needlessly quoting poetry", "the rm -rf command", "armchair activism"],
